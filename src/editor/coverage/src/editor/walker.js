...
_$jscoverage['/editor/walker.js'].branchData['365'][2].init(47, 21, 'tail[0].nodeType == 3');
function visit1129_365_2(result) {
  _$jscoverage['/editor/walker.js'].branchData['365'][2].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['365'][1].init(46, 56, 'tail[0].nodeType == 3 && tailNbspRegex.test(tail.text())');
function visit1128_365_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['365'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['364'][2].init(213, 23, 'tail.nodeName() == "br"');
function visit1127_364_2(result) {
  _$jscoverage['/editor/walker.js'].branchData['364'][2].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['364'][1].init(194, 115, 'tail && (!UA.ie ? tail.nodeName() == "br" : tail[0].nodeType == 3 && tailNbspRegex.test(tail.text()))');
function visit1126_364_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['364'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['362'][1].init(71, 23, 'tail && toSkip(tail[0])');
function visit1125_362_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['362'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['353'][1].init(41, 66, 'name in dtd.$inline && !(name in dtd.$empty)');
function visit1124_353_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['353'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['352'][2].init(141, 18, 'node.nodeType == 1');
function visit1123_352_2(result) {
  _$jscoverage['/editor/walker.js'].branchData['352'][2].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['352'][1].init(38, 108, 'node.nodeType == 1 && name in dtd.$inline && !(name in dtd.$empty)');
function visit1122_352_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['352'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['351'][1].init(35, 147, 'isWhitespaces(node) || node.nodeType == 1 && name in dtd.$inline && !(name in dtd.$empty)');
function visit1121_351_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['351'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['350'][1].init(63, 183, 'isBookmark(node) || isWhitespaces(node) || node.nodeType == 1 && name in dtd.$inline && !(name in dtd.$empty)');
function visit1120_350_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['350'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['339'][2].init(63, 42, 'node.nodeType == Dom.NodeType.ELEMENT_NODE');
function visit1119_339_2(result) {
  _$jscoverage['/editor/walker.js'].branchData['339'][2].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['339'][1].init(43, 64, 'node.nodeType == Dom.NodeType.ELEMENT_NODE && !node.offsetHeight');
function visit1118_339_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['339'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['338'][1].init(397, 108, 'whitespace(node) || node.nodeType == Dom.NodeType.ELEMENT_NODE && !node.offsetHeight');
function visit1117_338_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['338'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['321'][2].init(40, 39, 'node.nodeType == Dom.NodeType.TEXT_NODE');
function visit1116_321_2(result) {
  _$jscoverage['/editor/walker.js'].branchData['321'][2].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['321'][1].init(40, 90, 'node.nodeType == Dom.NodeType.TEXT_NODE && !S.trim(node.nodeValue)');
function visit1115_321_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['321'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['308'][1].init(382, 34, 'isBookmark || isBookmarkNode(node)');
function visit1114_308_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['308'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['305'][1].init(68, 76, '(parent = node.parentNode) && isBookmarkNode(parent)');
function visit1113_305_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['305'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['304'][2].init(132, 39, 'node.nodeType == Dom.NodeType.TEXT_NODE');
function visit1112_304_2(result) {
  _$jscoverage['/editor/walker.js'].branchData['304'][2].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['304'][1].init(132, 145, 'node.nodeType == Dom.NodeType.TEXT_NODE && (parent = node.parentNode) && isBookmarkNode(parent)');
function visit1111_304_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['304'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['297'][2].init(29, 28, 'Dom.nodeName(node) == \'span\'');
function visit1110_297_2(result) {
  _$jscoverage['/editor/walker.js'].branchData['297'][2].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['297'][1].init(29, 86, 'Dom.nodeName(node) == \'span\' && Dom.attr(node, \'_ke_bookmark\')');
function visit1109_297_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['297'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['281'][2].init(30, 42, 'node.nodeType == Dom.NodeType.ELEMENT_NODE');
function visit1108_281_2(result) {
  _$jscoverage['/editor/walker.js'].branchData['281'][2].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['281'][1].init(30, 116, 'node.nodeType == Dom.NodeType.ELEMENT_NODE && Dom._4e_isBlockBoundary(node, customNodeNames)');
function visit1107_281_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['281'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['239'][1].init(84, 40, 'iterate.call(this, TRUE, TRUE) !== FALSE');
function visit1106_239_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['239'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['228'][1].init(24, 41, 'iterate.call(this, FALSE, TRUE) !== FALSE');
function visit1105_228_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['228'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['141'][1].init(226, 38, 'breakOnFalseRetFalse && self.evaluator');
function visit1104_141_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['141'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['138'][1].init(21, 21, '!breakOnFalseRetFalse');
function visit1103_138_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['138'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['137'][2].init(69, 33, 'self.evaluator(node[0]) !== FALSE');
function visit1102_137_2(result) {
  _$jscoverage['/editor/walker.js'].branchData['137'][2].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['137'][1].init(50, 52, '!self.evaluator || self.evaluator(node[0]) !== FALSE');
function visit1101_137_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['137'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['135'][1].init(4052, 19, 'node && !self._.end');
function visit1100_135_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['135'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['129'][1].init(30, 43, 'guard(range.startContainer, TRUE) === FALSE');
function visit1099_129_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['129'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['125'][1].init(25, 24, 'guard(node[0]) === FALSE');
function visit1098_125_1(result) {
  _$jscoverage['/editor/walker.js'].branchData['125'][1].ranCondition(result);
  return result;
}_$jscoverage['/editor/walker.js'].branchData['124'][1].init(139, 11, 'node.length');
